...
export default function SlideRenderer({
  ...
  const contentTypeIcon: Record<string, React.ReactNode> = {
    image: <ImageIcon size={40} className="text-gray-300" />,
    pdf_page: <FileText size={40} className="text-gray-300" />,
    video: <Video size={40} className="text-gray-300" />,
    html: <Globe size={40} className="text-gray-300" />,
    text: <FileText size={40} className="text-gray-300" />,
  };
        ...
        >
          {slide.contentUrl ? (
            ...
            <div className="p-6 w-full h-full overflow-y-auto">
              ...
              <div
                className="prose prose-gray prose-base max-w-none"
